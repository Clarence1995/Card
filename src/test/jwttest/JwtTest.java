...
public class JwtTest {
    ...
    public void generateKeyTest() throws Exception {
        String subject = "{\"id\":233}";
        String s = createJWT("233",subject, System.currentTimeMillis());
        System.out.println(s);
        System.out.println(s.length()); // 245
    }

    @Test
    public void stringLength () {
        String s = "eyJhbGciOiJIUzI1NiJ9.eyJ1aWQiOiJEU1NGQVdEV0FEQVMuLi4iLCJzdWIiOiIiLCJ1c2VyX25hbWUiOiJhZG1pbiIsIm5pY2tfbmFtZSI6IkRBU0RBMTIxIiwiZXhwIjoxNTE3ODI4MDE4LCJpYXQiOjE1MTc4Mjc5NTgsImp0aSI6Imp3dCJ9.xjIvBbdPbEMBMurmwW6IzBkS3MPwicbqQa2Y5hjHSyo";
    ...
    public String createJWT (String id, String subject, long ttlMillis) throws Exception {
        ...
        keyGen.init(56); // 初始化密钥生成吕
        SecretKey key = keyGen.generateKey();
        // 生成签名的时候使用的秘钥secret,这个方法本地封装了的，
        // 一般可以从本地配置文件中读取，切记这个秘钥不能外露哦。它就是你服务端的私钥，
