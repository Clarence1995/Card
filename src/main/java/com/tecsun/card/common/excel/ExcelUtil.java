...
//        Field[] fields = ReflectUtils.getClassFieldsAndSuperClassFields(list.get(0).getClass());
     ...
     * @throws Exception
     */
    public List<E> readFromFile(ExcelDataFormatter edf, File file, String pattern) throws Exception {
        ...
        if (file.getName().endsWith(".xls")) {
            ...
            throw new FileNotFoundException("找不到以 .xls 或 .xlsx后缀结尾的文件");
        }
